...
template foobar( nAppUtxos, levels, nIns, nOuts, feeAsset, indexFeeAsset, indexPublicAsset, nAssets, nInAssets, nOutAssets) {
...
for (var appUtxoIndex = 0; appUtxoIndex < nAppUtxos; appUtxoIndex++) {
            	instructionHasher[appUtxoIndex] = Poseidon(6);
instructionHasher[appUtxoIndex].inputs[0] <== x0;
instructionHasher[appUtxoIndex].inputs[1] <== x1;
instructionHasher[appUtxoIndex].inputs[2] <== x2;
instructionHasher[appUtxoIndex].inputs[3] <== y0;
instructionHasher[appUtxoIndex].inputs[4] <== y1;
instructionHasher[appUtxoIndex].inputs[5] <== y2;
